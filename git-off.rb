...
on_macos do
    if Hardware::CPU.arm?
    url "https://github.com/emorydunn/homebrew-git-off/releases/download/0.0.1/gif-off-arm64.tar.gz"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/emorydunn/homebrew-git-off/releases/download/0.0.1/gif-off-amd64.tar.gz"
